  ...
  return (
    <ResponsiveShell>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="flex min-h-[100dvh] md:min-h-0 flex-col px-6 pt-14 pb-8"
      >
        {/* Logo */}
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3.5">
            ...
            <>
              ...
              {isLogin && (
                <button
                  ...
                  className="text-xs text-primary font-medium text-left px-1 -mt-1 hover:underline"
                >
                  Forgot password?
                </button>
              )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-1 flex h-14 w-full items-center justify-center rounded-2xl bg-foreground text-background font-medium transition-transform active:scale-[0.97] hover:opacity-90 disabled:opacity-50"
          >
            {loading ? (
